...
exports.promptToUpdateToolForModules = exports.getModFolderPath = exports.packagePathToGoModPathMap = exports.getCurrentPackage = exports.GO111MODULE = void 0;
        ...
        switch (selected) {
            case 'Update':
                ...
                if (tool === 'switchFormatToolToGoimports') {
                    ...
                    yield gopInstallTools_1.installTools([goTools_1.getTool(tool)], goVersion);
                }
