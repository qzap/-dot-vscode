...
exports.getActiveGoRoot = exports.offerToInstallTools = exports.updateGoVarsFromConfig = exports.promptForUpdatingTool = exports.promptForMissingTool = exports.installTool = exports.installTools = exports.installAllTools = void 0;
...
function installAllTools(updateExistingToolsOnly = false) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let allTools = goTools_1.getConfiguredTools();
        // exclude tools replaced by alternateTools.
        const alternateTools = util_1.getGoPlusConfig().get('alternateTools');
...
function installTool(tool, goVersion, envForTools, modulesOn) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let importPath;
        if (!modulesOn) {
            importPath = goTools_1.getImportPath(tool);
        }
        else {
            importPath = goTools_1.getImportPathWithVersion(tool, tool.version);
        }
        ...
        try {
            ...
            gopStatus_1.outputChannel.appendLine(`Installing ${importPath} SUCCEEDED`);
        }
        catch (e) {
            gopStatus_1.outputChannel.appendLine(`Installing ${importPath} FAILED`);
...
function promptForMissingTool(toolName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let missing = yield getMissingTools();
...
Run "go get -v ${goTools_1.getImportPath(tool)}" to install.`;
        ...
        if (missing.length > 0) {
            vscode.commands.registerCommand('go.promptforinstall', () => {
                ...
                const showItem = {
                    ...
                    command() {
                        gopStatus_1.outputChannel.clear();
                        gopStatus_1.outputChannel.appendLine('Below tools are needed for the basic features of the Go extension.');
                        missing.forEach((x) => gopStatus_1.outputChannel.appendLine(x.name));
                    }
                };
                vscode.window
...
function getMissingTools() {
    const keys = goTools_1.getConfiguredTools();
...
//# sourceMappingURL=gopInstallTools.js.map