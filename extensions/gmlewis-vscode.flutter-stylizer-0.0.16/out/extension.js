...
const findMatchingBracket = (editor, openParenOffset) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getClasses = (editor) => __awaiter(void 0, void 0, void 0, function* () {
...
const validateMemberOrdering = () => {
    ...
    const memberOrdering = vscode.workspace.getConfiguration('flutterStylizer').get('memberOrdering');
    ...
    let lookup = new Map(defaultOrdering.map((el) => [el, true]));
    let seen = new Map();
...
// export for testing only.
exports.reorderClass = (memberOrdering, dc) => {
    let lines = new Array();
...
function activate(context) {
    ...
    let disposable = vscode.commands.registerCommand('extension.flutterStylizer', () => __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = classes.length - 1; i >= 0; i--) {
            ...
            let lines = exports.reorderClass(memberOrdering, dc);
