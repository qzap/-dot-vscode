        ...
        while (index < length) {
            ...
            switch (character) {
                ...
                case ' ':
                    ...
                    return { type: 'whitespace', raw: value };
                case '{':
                case '}':
                case '[':
                case ']':
                ...
                case ',':
                    ...
                    return { type: 'punctuator', raw: punctuator };
                case '"':
                    ...
                    if (source[index] === '"') {
                        ...
                        return { type: 'string', raw: rawString };
                    }
                ...
                default:
                    ...
                    if (charCode >= 48 && charCode <= 57) {
                        ...
                        return { type: 'number', raw: numberString };
                    }
                    if (isSigned) {
                    ...
                    if (temp === 'true') {
                        index += 4;
                        return { type: 'literal', raw: 'true' };
                    }
                    else if (temp === 'fals' && source[index + 4] === 'e') {
                        index += 5;
                        return { type: 'literal', raw: 'false' };
                    }
                    else if (temp === 'null') {
                        index += 4;
