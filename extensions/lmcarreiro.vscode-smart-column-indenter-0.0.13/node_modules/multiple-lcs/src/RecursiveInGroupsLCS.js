...
const BaseLCS_1 = require("./BaseLCS");
/**
 ...
 */
class RecursiveInGroupsLCS extends BaseLCS_1.default {
    executeForMoreThanThree(sequences) {
        const firstTwo = this.execute([sequences[0], sequences[1]]);
        return this.execute([firstTwo, ...sequences.slice(2)]);
    }
}
exports.default = RecursiveInGroupsLCS;
//# sourceMappingURL=RecursiveInGroupsLCS.js.map