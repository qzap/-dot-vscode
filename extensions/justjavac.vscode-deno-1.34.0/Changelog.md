...
- use `execa` instead of `child_process.exec` [#6](https://github.com/denoland/vscode_deno/issues/6)
- refactor: improve performance [#7](https://github.com/denoland/vscode_deno/issues/7) [#9](https://github.com/denoland/vscode_deno/issues/9)
- add import snippets for deno std [#8](https://github.com/denoland/vscode_deno/issues/8)

## 1.0.4 - 2019-03-07

- Fix warning on found [#3](https://github.com/denoland/vscode_deno/issues/3)
