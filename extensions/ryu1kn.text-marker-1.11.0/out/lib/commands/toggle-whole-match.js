...
class ToggleWholeMatchCommand {
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            const decorationOpt = yield this.decorationPicker.pick('Select a pattern to toggle partial/whole match');
...
exports.default = ToggleWholeMatchCommand;
//# sourceMappingURL=toggle-whole-match.js.map