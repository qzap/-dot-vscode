...
class UnhighlightCommand {
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            const decorationOpt = yield this.decorationPicker.pick('Select a pattern to remove highlight');
...
exports.default = UnhighlightCommand;
//# sourceMappingURL=unhighlight.js.map